<form id="formNuevoUsuario" class="form-horizontal">
	<section class="content">
		...
		<div class="top-spaced" id="div_acciones" align="right">
            ...
            <?php else: ?>
                <button class="btn btn-success" type="button" onclick="MantenedorSeremi.agregarSeremi($(this.form).serializeArray(), this);"><i class="fa fa-save"></i> <?php echo \Traduce::texto("Guardar"); ?> </button>
            <?php endif; ?>
