<div class="card card-primary">
	...
	<div class="card-body">
        <div class="row">
            <div class="col-2">
                <label for="gl_rut_seremi" class="control-label required-left">RUT Seremi</label>
            </div>
            <div class="col-4">
                <input type="text" class="form-control"  id="gl_rut_seremi" name="gl_rut_seremi" value="<?php echo (isset($arr->gl_rut))?$arr->gl_rut:""; ?>"
                    ...
                    onblur="Valida_Rut(this); Utils.cargarPersonaWS(this.value,'gl_nombre_seremi','gl_apellido_paterno_seremi','gl_apellido_materno_seremi');" />
            </div>
            ...
            <div class="input-group">
                    <input type="text" data-date-format='yy-mm-dd'  class="form-control float-left datepicker" id="fc_nacimiento_seremi" name="fc_nacimiento_seremi"
        ...
        <div class="row top-spaced">
            <div class="col-2">
                <label for="id_profesion_seremi" class="control-label required-left">Trato</label>
            </div>
            <div class="col-4">            
                <select class="form-control" id="id_trato_seremi" name="id_trato_seremi" >
                    ...
                    <?php if (isset($arrTrato) && is_array($arrTrato)) : foreach ($arrTrato as $key => $trato) : ?>
                            <option value="<?php echo $trato->seremi_trato; ?>" <?php echo (isset($arr->seremi_trato) && $arr->seremi_trato == $trato->seremi_trato)?"selected":""; ?> ><?php echo $trato->seremi_trato; ?></option>
                    <?php endforeach;
                    endif; ?>
                </select>
            </div>
            ...
            <div class="col-4">
                <input type="text" class="form-control" id="gl_nombre_seremi" name="gl_nombre_seremi" onkeypress="return soloLetras(event)" value="<?php echo (isset($arr->gl_nombres))?$arr->gl_nombres:""; ?>"
        ...
        <div class="row top-spaced">
            ...
            <div class="col-4">
                <input type="text" class="form-control" id="gl_apellido_paterno_seremi" name="gl_apellido_paterno_seremi" onkeypress="return soloLetras(event)" value="<?php echo (isset($arr->gl_apellido_paterno))?$arr->gl_apellido_paterno:""; ?>"
                    <?php echo (isset($arr->gl_rut) && isset($arr->bo_ws_validado) && $arr->bo_ws_validado)?"readonly":""; ?>/>
            </div>
            <div class="col-2">
            ...
            <div class="col-4">
                <input type="text" class="form-control" id="gl_apellido_materno_seremi" name="gl_apellido_materno_seremi" onkeypress="return soloLetras(event)" value="<?php echo (isset($arr->gl_apellido_materno))?$arr->gl_apellido_materno:""; ?>"
                    <?php echo (isset($arr->gl_rut) && isset($arr->bo_ws_validado) && $arr->bo_ws_validado)?"readonly":""; ?>/>
            </div>
        </div>
        ...
        <div class="row top-spaced">
            ...
            <div class="col-4">
                <div class="row">
                    <div class="col-sm-6">
                        <label><input type="radio" class="labelauty" id="chk_genero_seremi_m" name="chk_genero_seremi" value="M" <?php echo ($arr->chk_genero == "M")?"checked":""; ?> data-labelauty="Masculino" /></label>
                    </div>
                    <div class="col-sm-6">
                        <label><input type="radio" class="labelauty" id="chk_genero_seremi_f" name="chk_genero_seremi" value="F" <?php echo ($arr->chk_genero == "F")?"checked":""; ?> data-labelauty="Femenino" /></label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row top-spaced">
            ...
            <div class="col-4">
                <input type="text" class="form-control" id="gl_ds_decreto" onkeypress="return soloNumeros(event)" name="gl_ds_decreto"/>    
            </div> 
            <div class="col-2">
        ...
        <div class="row top-spaced" id="form_firma_delegada" style="display: none;">
            <div class="col-2">
                <label class="control-label required-left">Decreto Firma Delegada</label>
            </div>
            <div class="col-4">
                <input type="text" class="form-control" id="gl_ds_decreto_delegado" onkeypress="return soloNumeros(event)" name="gl_ds_decreto_delegado"
            ...
            <div class="col-4">
                <div class="input-group">
                        <input type="text" class="form-control float-left datepicker" id="fc_ds_delegado" name="fc_ds_delegado"
                            value="<?php echo (isset($arrDatosSeremi->fc_decreto))?\Fechas::formatearHtml($arrDatosSeremi->fc_decreto):""; ?>" autocomplete="off">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                                <i class="far fa-calendar-alt"></i>
                            </span>
            ...
            <div class="col-4">
                <select class="form-control" id="id_territorio_seremi" name="id_territorio_seremi">
                    ...
                    <?php if (isset($arrTerritorio) && is_array($arrTerritorio)) : foreach ($arrTerritorio as $key => $territorio) : ?>
                            <option value="<?php echo $territorio->territorio_id ?>" data-region="<?php echo $territorio->fk_region ?>" <?php echo (isset($arr->territorio_id) && $arr->territorio_id == $territorio->territorio_id)?"selected":""; ?> ><?php echo $territorio->nombre_territorio; ?></option>
                    <?php endforeach;
                    endif; ?>
                </select>
            </div>
        ...
        <div class="row top-spaced">
            ...
            <div class="col-4">
                <input type="text" class="form-control" id="gl_telefono_seremi" name="gl_telefono_seremi" value="<?php echo (isset($arr->gl_telefono))?$arr->gl_telefono:""; ?>"/>
            </div>
        </div>
	</div>
</div>
