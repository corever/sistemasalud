      ...
      <div class="row mb-2">
         <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item"><?php echo \Traduce::texto("Turnos"); ?></li>
               <li class="breadcrumb-item active"><?php echo \Traduce::texto("Administrar Turnos"); ?></li>
            </ol>
         </div>
         <div class="col-sm-6">
            <?php /*
         ...
         <div class="col-md-12">
            <div class="card card-primary">
               <div class="card-header">
                  <h3 class="card-title"><?php echo \Traduce::texto("Listado de Turnos"); ?></h3>
               </div>
               <div class="card-body">
