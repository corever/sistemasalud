	...
	<table style='width:100%' class='table table-striped border-gray' id="tabla_horarios">
		<thead>
			...
			<th id='lunes' name ='lunes' class='lunes row_lunes bg-primary text-center'>
				<div class="row">
					<div class="col-md-8 col-sm-8" style="margin-top:6px;font-size:14px;">
						<b>Lunes</b>
					</div>
			...
			<?php endif;?>>
				...
				<td class='lunes row_lunes'>
					<div class='input-group' style="min-width:110px">
						<input class='form-control timepicker<?php if($horario["bo_no_continuado"]):?> ipt_no_continuado<?php endif;?>' id='<?php echo $horario["id"];?>_lunes' name='lunes_<?php echo $horario["id"];?>' value='' readonly></input>
				...
				<td class='martes row_martes'>
					<div class='input-group' style="min-width:110px">
						<input class='form-control timepicker<?php if($horario["bo_no_continuado"]):?> ipt_no_continuado<?php endif;?>' id='<?php echo $horario["id"];?>_martes' name='martes_<?php echo $horario["id"];?>' value='' readonly></input>
						<span class='input-group-append'>
							<span class="input-group-text">
								<i class="far fa-clock"></i>
							</span>
				...
				<td class='miercoles row_miercoles'>
					<div class='input-group' style="min-width:110px">
						<input class='form-control timepicker<?php if($horario["bo_no_continuado"]):?> ipt_no_continuado<?php endif;?>' id='<?php echo $horario["id"];?>_miercoles' name='miercoles_<?php echo $horario["id"];?>' value='' readonly></input>
						<span class='input-group-append'>
							<span class="input-group-text">
								<i class="far fa-clock"></i>
							</span>
				...
				<td class='jueves row_jueves'>
					<div class='input-group' style="min-width:110px">
						<input class='form-control timepicker<?php if($horario["bo_no_continuado"]):?> ipt_no_continuado<?php endif;?>' id='<?php echo $horario["id"];?>_jueves' name='jueves_<?php echo $horario["id"];?>' value='' readonly></input>
						<span class='input-group-append'>
							<span class="input-group-text">
								<i class="far fa-clock"></i>
							</span>
				...
				<td class='viernes row_viernes'>
					<div class='input-group' style="min-width:110px">
						<input class='form-control timepicker<?php if($horario["bo_no_continuado"]):?> ipt_no_continuado<?php endif;?>' id='<?php echo $horario["id"];?>_viernes' name='viernes_<?php echo $horario["id"];?>' value='' readonly></input>
						<span class='input-group-append'>
							<span class="input-group-text">
								<i class="far fa-clock"></i>
							</span>
				...
				<td class='sabado row_sabado'>
					<div class='input-group' style="min-width:110px">
						<input class='form-control timepicker<?php if($horario["bo_no_continuado"]):?> ipt_no_continuado<?php endif;?>' id='<?php echo $horario["id"];?>_sabado' name='sabado_<?php echo $horario["id"];?>' value='' readonly></input>
						<span class='input-group-append'>
							<span class="input-group-text">
								<i class="far fa-clock"></i>
							</span>
				...
				<td class='domingo row_domingo'>
					<div class='input-group' style="min-width:110px">
						<input class='form-control timepicker<?php if($horario["bo_no_continuado"]):?> ipt_no_continuado<?php endif;?>' id='<?php echo $horario["id"];?>_domingo' name='domingo_<?php echo $horario["id"];?>' value='' readonly></input>
						<span class='input-group-append'>
							<span class="input-group-text">
								<i class="far fa-clock"></i>
							</span>
				...
				<td class='festivo row_festivo'>
					<div class='input-group' style="min-width:110px">
						<input class='form-control timepicker<?php if($horario["bo_no_continuado"]):?> ipt_no_continuado<?php endif;?>' id='<?php echo $horario["id"];?>_festivo' name='festivo_<?php echo $horario["id"];?>' value='' readonly></input>
						<span class='input-group-append'>
							<span class="input-group-text">
								<i class="far fa-clock"></i>
							</span>
