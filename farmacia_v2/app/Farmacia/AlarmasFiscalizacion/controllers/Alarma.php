...
namespace App\Farmacia\AlarmasFiscalizacion;
 ...
 * Creación          : 24/08/2020
 *
 * @name             Alarma.php - Ejemplo para copiar y pegar
 *
 * @version          1.0.0
 *
...
class Alarma extends \pan\Kore\Controller{
