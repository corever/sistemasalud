...
namespace App\Farmacia\Recetas;
 ...
 * Creación          : 24/08/2020
 *
 * @name             AdminMedicamentos.php - Ejemplo para copiar y pegar
 *
 * @version          1.0.0
 *
...
class AdminMedicamentos extends \pan\Kore\Controller{
	...
	public function index(){
		...
		$this->view->addJS('adminMedicamentos.js');
