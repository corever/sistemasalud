         ...
         <div class="col-sm-6">
            <!--<h1></h1>-->
             ...
             <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item active">Perfil Medico</li>
            </ol>
         </div>
      </div>
   </div>
            ...
            <div class="col-4">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="profile-username text-center"><?php echo $medico->gl_nombres.' '.$medico->gl_apellidos ?></h3>
                        <p class="text-muted text-center"><?php echo $medico->gl_email ?></p>
                    </div>
                </div>
            </div>
            <div class="col-8">
