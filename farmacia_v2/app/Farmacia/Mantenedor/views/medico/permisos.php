        ...
        <div class="person">
            ...
            <div class="checkbox checkbox-success">
                <input class="styled" data-orden="1" value="1"
                    <?php if (in_array("1",$permisosMedico[$id_opcion_permiso])): ?> checked <?php endif; ?>
        ...
        <div class="person">
            ...
            <div class="checkbox checkbox-success">
                <input class="styled" data-orden="2" value="2"
                    <?php if (in_array("2",$permisosMedico[$id_opcion_permiso])): ?> checked <?php endif; ?>
        ...
        <div class="person">
            ...
            <div class="checkbox checkbox-success">
                <input class="styled" data-orden="3" value="3"
                    <?php if (in_array("3",$permisosMedico[$id_opcion_permiso])): ?> checked <?php endif; ?>
