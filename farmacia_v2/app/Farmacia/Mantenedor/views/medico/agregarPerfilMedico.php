<form id="formNuevoPerfilMedico" class="form-horizontal" autocomplete="off">
	<section class="content">
        <div class="form-group">
            ...
            <div class="card card-primary" id="card_perfiles">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="id_perfil_medico" class="control-label required"><?php echo \Traduce::texto("Perfil"); ?></label>
                            <div>
                                <select class="form-control select2" id="id_perfil_medico" name="id_perfil_medico">
        ...
        <div class="top-spaced" align="right" id="btn-terminar" style="background-color: #dddddd;">
            <button class="btn btn-success" type="button" onclick="MantenedorMedico.agregarPerfilMedico($(this.form).serializeArray(), this);"><i class="fa fa-save"></i>&nbsp; <?php echo \Traduce::texto("Guardar"); ?> </button>
