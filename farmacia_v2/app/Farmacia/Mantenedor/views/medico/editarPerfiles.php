	...
	<section class="content">
        <div class="form-group">
            ...
            <div class="card card-primary">
                <div class="card card-header"><?php echo \Traduce::texto("Perfiles Medico"); ?></div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12" align="right">
                            <button type="button" class="btn btn-xs btn-success" data-toggle="tooltip" title="<?php echo \Traduce::texto("Agregar Perfil Medico"); ?>"
                                    onclick="xModal.open('<?php echo \pan\uri\Uri::getHost(); ?>Farmacia/Mantenedor/Medico/agregarPerfilMedico/<?php echo $gl_token; ?>','<?php echo \Traduce::texto('Agregar Perfil Medico'); ?>',40);">
                        ...
                        <div class="table-responsive col-md-12" id="contenedor-grilla-perfiles">
                            <?php include_once("grillaPerfilesMedico.php"); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="top-spaced" align="right" id="btn-terminar" style="background-color: #dddddd;">
            <!--button class="btn btn-success" type="button" onclick="Mantenedor_medico.editarPerfiles($(this.form).serializeArray(), this);"><i class="fa fa-save"></i>&nbsp; Guardar </button-->
