         ...
         <div class="col-sm-6">
            <!--<h1></h1>-->
             ...
             <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item active"><?php echo \Traduce::texto("Mantenedor Medicos"); ?></li>
            </ol>
         </div>
         <div class="col-sm-6">
            <button type="button" class="btn bg-teal btn-xs mt-2" style="float:right;"
            onclick="xModal.open('<?php echo \Pan\Uri\Uri::getBaseUri(); ?>Farmacia/Mantenedor/Medico/agregarMedico/','Agregar Medico','90');">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title"><?php echo \Traduce::texto("Lista de Medicos"); ?></h3>
                </div>
                <div class="card-body">
                  <div class="table-responsive col-lg-12" data-row="10">
                      <div id="contenedor-tabla-medico">
                        <?php echo $grilla ?>
                      </div>
                  </div>
                </div>
