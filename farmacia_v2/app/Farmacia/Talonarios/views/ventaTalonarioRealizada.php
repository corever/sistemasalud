...
<form id="formVentaTalonarioRealizada" class="form-horizontal">
    <div class="row">
        <div class="col-8">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="top-spaced" id="div_acciones" align="right">
                        <button class="btn btn-success" type="button" onclick="window.open('<?php echo \Pan\Uri\Uri::getBaseUri(); ?>Farmacia/Talonarios/Talonario/verBoleta/<?php echo $id_venta; ?>/');"><i class="fa fa-file"></i> <?php echo \Traduce::texto("Ver Boleta"); ?> </button>
                    </div>
                </div>
            </div>
        </div>
