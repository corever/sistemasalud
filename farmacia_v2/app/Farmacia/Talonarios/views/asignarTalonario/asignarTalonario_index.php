      ...
      <div class="row mb-2">
         <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item active"><?php echo \Traduce::texto("Asignación de Talonario Cheque"); ?></li>
            </ol>
         </div>
         <div class="col-sm-6">
            <?php /*
...
<?php echo $asignarTalonario_informacionBodega; ?>

<!-- Filtros de Busqueda -->
<!-- <section id="collapseFilter" class="content panel-collapse collapse in">
   <div class="container-fluid">
      <div class="row mb-2">
         <?php // echo $asignarTalonario_filtros; 
         ?>
      </div>
   </div>
</section> -->
         ...
         <div class="col-md-12">
            <div class="card card-primary">
               <div class="card-header">
                  <h3 class="card-title"><?php echo \Traduce::texto("Lista de Talonarios"); ?></h3>
               </div>
               <div class="card-body">
                  <div class="table-responsive col-lg-12" data-row="10">
                     <div id="contenedor-tabla-asignarTalonario">
                        <?php echo $asignarTalonario_grilla; ?>
                     </div>
                  </div>
               </div>
               <div class="card-footer">
                  <button type="button" class="btn btn-sm btn-success" onclick="asignarTalonario.asignarTalonariosSeleccionados()" data-toggle="tooltip" title="Guardar">
                     <i class="fa fa-save"></i>
                     &nbsp;&nbsp;Asignar Talonarios
                  </button>
                  <button type="button" class="btn btn-sm btn-warning" onclick="dt_GrillaAsignarTalonario.rows().deselect();" title="Cancelar">
