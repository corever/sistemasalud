...
<form id="formModulo" class="form-horizontal" method="post" enctype="multipart/form-data">
	<section class="content">
		<div class="card card-primary">
            <div class="card-header"> <?php echo \Traduce::texto("Módulos Usuario"); ?> </div>
			<div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php foreach($arrModulo as $key => $item): ?>
                        ...
                        <div class="col-lg-3 col-6">
                            <!-- small box -->
                            <div class="small-box <?php echo (array_key_exists($item->id_modulo,$arrModuloUsuario))?$item->gl_color:"default"; ?>"
                                ...
                                <div class="inner">
                                    ...
                                    <div class="col-12"><button type="button" id="btnModuloEditar<?php echo $item->id_modulo ?>" class="btn btn-sm btn-default btnModuloEditar" data-color="<?php echo $item->gl_color; ?>" onclick="MantenedorUsuario.editarOpcionesModulo(<?php echo $item->id_modulo; ?>,'<?php echo \Traduce::texto($item->gl_nombre); ?>','<?php echo $arr_color[1]; ?>');" <?php echo ($cont == 1)?"disabled":""; ?>><i class="fa fa-edit"></i>&nbsp;Editar</button></div>
                                ...
                                <div class="small-box-footer" >
                                    <input type="checkbox" onclick="MantenedorUsuario.seleccionarModulo(this);" data-id_modulo="<?php echo $item->id_modulo; ?>"
                                            <?php echo (array_key_exists($item->id_modulo,$arrModuloUsuario))?"checked":""; ?>
                                            id="chk_modulo_<?php echo $item->id_modulo; ?>" name="chk_modulo_<?php echo $item->id_modulo; ?>">
                                            <label id="label_modulo_<?php echo $item->id_modulo ?>" style="color:black;"><?php echo (array_key_exists($item->id_modulo,$arrModuloUsuario))?\Traduce::texto("Seleccionado"):\Traduce::texto("Seleccionar"); ?></label>
                                </div>
                            </div>
                        </div>
		...
		<div class="top-spaced" id="btn-terminar"  align="right">
			<button class="btn btn-success" type="button" onclick="MantenedorUsuario.editarModulo(this.form, this);"><i class="fa fa-save"></i> <?php echo \Traduce::texto("Guardar"); ?> </button>
