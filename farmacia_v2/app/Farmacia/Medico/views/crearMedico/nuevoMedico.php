<div class="card card-primary">
	<div class="card-header"> Registrar Nuevo Médico </div>
	<div class="card-body">
		...
		<form method="POST">
			...
			<div id="div_general_0" class="top-spaced" style="border-style: solid; border-width: 1px; border-color: #ced4da;">
				...
				<div class="row top-spaced">
					...
					<div class="col-5">
						<select id="selectRegion_0" class="form-control" required>
					...
					<div class="col-5">
						<select id="selectComuna_0" class="form-control" required>
					...
					<div class ="row top-spaced">
							...
							<div class="col-5">
								<input type="text" class="form-control" id="direccion_0" required>
							</div>
							<div class="col-1">
								<label class="control-label required-left">Teléfono</label>
							</div>
							<div class="col-5">
								<input type="text" class="form-control" id="telefono_0" required>
							</div>
