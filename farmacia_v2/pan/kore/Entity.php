...
use Pan\ValidatePan as validatePan;
...
class Entity
{
    ...
    public function where($where = array(), $parameters = null)
    {
        ...
        $query = "select ";
        if (empty($parameters) or is_null($parameters))
            $parameters = '*';
        ...
        if (is_null($parameters)) {
            ...
            if (\pan\Utils\ValidatePan::isArray($parameters)) {
                foreach ($parameters as $field) {
                    $query .= $field . ', ';
                }
                $query = trim($query, ', ');
            } elseif (\pan\Utils\ValidatePan::isLiteral($parameters)) {
                $query .= $parameters . ' ';
            }
        }
