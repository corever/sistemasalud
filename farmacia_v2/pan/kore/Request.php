...
class Request
{
	...
	public static function getParametrosSelect2($parametro = null)
	{
		$_post_params = array();

		if(isset($_GET)){
			Seguridad::validarPost($_GET);
			
			foreach($_GET as $request_key => $request_value){
				$_post_params[$request_key] = $request_value;
				//unset($_POST[$request_key]);
			}
		}
