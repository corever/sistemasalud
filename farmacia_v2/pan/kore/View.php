...
class View
{
    ...
    public static function render($template = null, $arr_data = null, $full_path = false)
    {
        ...
        if(!empty($template) or !is_null($template)){
            ...
            if ($full_path) {
                ...
                $_template = 'app' . DIRECTORY_SEPARATOR . Request::getModulo() .DIRECTORY_SEPARATOR . Request::getSubModulo() . DIRECTORY_SEPARATOR . self::$dir_views . DIRECTORY_SEPARATOR . $template;
            }
    ...
    public static function addCSS($css)
    {
        if (!filter_var($css, FILTER_VALIDATE_URL) === false) {
            ...
            $path = "app/" . Request::getModulo() . "/" . Request::getSubModulo() . "/assets/css/".$css;
    ...
    public static function addJS($javascript, $dir = null)
    {
        ...
        if (!filter_var($javascript, FILTER_VALIDATE_URL) === false) {
            ...
            if(!is_null($dir)){
                ...
                $path_js = "app/" . Request::getModulo() . "/" . Request::getSubModulo() . "/assets/js/" . $javascript;
