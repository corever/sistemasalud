<?php
	...
	if($arr_respuesta->bo_estado){
		...
		$arr_datos				=	array(
			...
			"gl_fono_codigo"						=>	"34",
			"gl_fono"								=>	"3444561",
			"bo_clasificacion_alopatica"			=>	TRUE,
			"bo_clasificacion_homeopatica"			=>	TRUE,
			"bo_clasificacion_movil"				=>	FALSE,
		...
		$data	= array(
					...
					'hash'			=> $hash,
					'version_ws'	=> '1.0',
					'metodo'		=> 'editarEstablecimiento',
					'Accept'		=> 'application/json',
					'appVersion'	=> '1.0.0',

					'gl_codigo'		=>	'FA06436',
					'token_visita'	=>	'0de58aaf-ee73-4a02-b8c0-9c29c36195e0',
