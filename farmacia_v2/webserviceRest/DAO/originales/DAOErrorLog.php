...
class DAOErrorLog{
	...
	function setLogAuditoria($json_servicio, $gl_rut, $id_usuario, $gl_version_ws, $gl_version_app, $gl_token, $cd_codigo_resultado, $gl_funcion)
	{
		$ip_publica		= '0.0.0.0';
		$ip_privada		= '0.0.0.0';
		$id_expediente	= 0;
		...
		if(empty($id_usuario) && !empty($gl_rut)){
	...
	function setLogAuditoriaBichito($json_servicio, $id_usuario, $gl_rut, $tipo_log, $gl_version_ws, $gl_version_app, $gl_token, $nr_ws_success, $gl_origen)
	{
		...
		$sql = "INSERT INTO auditoria_ws_bichito ( 
							id_usuario,
							gl_rut,
							gl_origen,
							gl_tipo_log,
