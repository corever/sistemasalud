...
(function ($) {
    ...
    function Timepicker() {
        var tiempo = new Date();                    //Añadido por David
        var horaDefecto = tiempo.getHours()+":00";  //Añadido por David
        ...
        this._defaults = { // Global defaults for all the time picker instances
            ...
            defaultTime: horaDefecto,       // Used as default time when input field is empty or for inline timePicker
