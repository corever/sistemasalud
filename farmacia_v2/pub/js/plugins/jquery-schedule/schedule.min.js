/** jQuery Schedule v2.2.0 | https://github.com/Yehzuna/jquery-schedule */ ! function (t, i, e, o) {
    "use strict";
    ...
    var r = {
        ...
        daysList: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday","Feriado"],
        onInit: function () {},
    ...
    t.extend(s.prototype, {
        ...
        init: function () {
            ...
            if (this.periodInterval = 60 / this.settings.periodDuration, this.periodHeight = 24 * this.periodInterval, this.periodPosition = 40 / this.periodInterval, t(this.element).addClass("jqs").addClass("jqs-mode-" + this.settings.mode).addClass("jqs").addClass("jqs-mode-" + this.settings.days), "edit" === this.settings.mode) {
                var e = 0,
                    o = !1;
        ...
        create: function () {
            ...
            for (var i = 0; i < this.settings.days; i++) t('<td><div class="jqs-day"></div></td>').appendTo(t(".jqs-table tr", this.element));
            t('<div class="jqs-grid"><div class="jqs-grid-head"></div></div>').appendTo(t(this.element));
            for (var e = 0; e < 25; e++) t('<div class="jqs-grid-line"><div class="jqs-grid-hour"><b>' + this.formatHour(e) + "</b></div></div>").appendTo(t(".jqs-grid", this.element));
            var o = "",
                s = "";
            ...
            for (var r = 0; r < this.settings.days; r++) t('<div class="jqs-grid-day">' + this.settings.daysList[r] + o + s + "</div>").appendTo(t(".jqs-grid-head", this.element))
        },
        generate: function () {
            if (this.settings.data.length > 0) {
                ...
                t.each(this.settings.data, function (e, o) {
                    t.each(o.periods, function (e, s) {
                        var r, n, d = t(".jqs-day", i.element).eq(o.day),
                            a = {};
        ...
        add: function (i, e, o, s) {
            ...
            var d = '<div class="jqs-period-title rotate-l-90">' + s.title + "</div>",
                a = '<div class="jqs-period-time text-center"><h6><b>' + this.periodInit(e, e + o) + "</b></h6></div>",
        ...
        import: function (i) {
            ...
            return t.each(o, function (i, o) {
                t.each(o.periods, function (i, r) {
                    var n, d, a = t(".jqs-day", e.element).eq(o.day),
                        p = {};
