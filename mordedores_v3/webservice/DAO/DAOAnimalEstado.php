 ...
 * 
 * Descripcion       : Modelo para Tabla mor_animal_estado
 *
 * Plataforma        : !PHP
 * 
 * Creacion          : 15/05/2018
 * 
 * @name             DAOAnimalEstado.php
 * 
 * @version          1.0
 *
 ...
 * ****************************************************************************
 */
class DAOAnimalEstado{

    protected $_tabla           = "mor_animal_estado";
    protected $_primaria		= "id_animal_estado";
