 ...
 * 
 * Descripcion       : Modelo para Tabla mor_vacuna_tipo
 *
 * Plataforma        : !PHP
 * 
 * Creacion          : 15/05/2018
 * 
 * @name             DAOTipoVacuna.php
 * 
 * @version          1.0
 *
...
class DAOTipoVacuna{
    ...
    protected $_tabla           = "mor_vacuna_tipo";
    protected $_primaria        = "id_tipo_vacuna";
