 ...
 * 
 * Descripcion       : Modelo para Tabla mor_visita_estado
 *
 * Plataforma        : !PHP
 * 
 * Creacion          : 15/05/2018
 * 
 * @name             DAOVisitaEstado.php
 * 
 * @version          1.0
 *
 ...
 * ****************************************************************************
 */
class DAOVisitaEstado{

    protected $_tabla           = "mor_visita_estado";
    protected $_primaria		= "id_visita_estado";
