 ...
 * 
 * Descripcion       : Modelo para Tabla mor_vacuna_laboratorio_tipo
 *
 * Plataforma        : !PHP
 * 
 * Creacion          : 15/05/2018
 * 
 * @name             DAOTipoLaboratorio.php
 * 
 * @version          1.0
 *
...
class DAOTipoLaboratorio{

    protected $_tabla           = "mor_vacuna_laboratorio_tipo";
    protected $_primaria        = "id_tipo_laboratorio";
