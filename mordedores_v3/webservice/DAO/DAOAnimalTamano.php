 ...
 * 
 * Descripcion       : Modelo para Tabla mor_animal_tamano
 *
 * Plataforma        : !PHP
 * 
 * Creacion          : 15/05/2018
 * 
 * @name             DAOAnimalTamano.php
 * 
 * @version          1.0
 *
 ...
 * ****************************************************************************
 */
class DAOAnimalTamano{

    protected $_tabla           = "mor_animal_tamano";
    protected $_primaria		= "id_animal_tamano";
