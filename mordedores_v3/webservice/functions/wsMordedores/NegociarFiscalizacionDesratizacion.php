<?php
	...
	$server->wsdl->addComplexType(
		'negociarFiscalizacionDesratizacionInput',
		'complexType',
		'struct',
		'all',
		'',
	...
	// Salida
	$server->wsdl->addComplexType(
	    'negociarFiscalizacionDesratizacionOutput',
        'complexType',
		'struct',
		'sequence',
		'',
	...
	$server->register(  'negociarFiscalizacionDesratizacion',
						array('data'	=> 'tns:negociarFiscalizacionDesratizacionInput'),
						array('return'	=> 'tns:negociarFiscalizacionDesratizacionOutput'),
	...
	function negociarFiscalizacionDesratizacion($arrWs){
		//$conn =  new MySQL();
		//$daoUsuario = new DAOUsuario($conn);
		//$daoErrorLog = new DAOErrorLog($conn);
		//$daoDesratizacion = new DAODesratizacion();
		
		$service_name = "negociarFiscalizacionDesratizacionRequest";
		$service_name_response = "negociarFiscalizacionDesratizacionResponse";
