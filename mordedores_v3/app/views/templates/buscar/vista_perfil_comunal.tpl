		            ...
		            <div class="col-sm-4">
						...
						<div class="col-sm-8">
							<select name="id_servicio" id="id_servicio" class="form-control"
                                    onchange="if(this.value>0) Region.cargarEstableSaludporServicio(this.value, 'establecimiento_salud'); else $('#comuna').trigger('change');" >
					...
					<div class="col-sm-4">
						...
						<div class="col-sm-8">
							<select for="comuna" class="form-control" id="comuna" name="comuna"
                                    onchange="Region.cargarCentroSaludporComuna(this.value, 'establecimiento_salud');">
