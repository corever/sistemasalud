<div class="table-responsive col-lg-12" data-row="10">
    <table id="tablaPrincipal" class="table table-hover table-striped table-bordered dataTable no-footer" data-sorting="{($bandeja == 'nacional' or $bandeja == 'admin')?4:3}" data-bandeja="{$bandeja}">
        <thead>
            <tr role="row">
        ...
        <tbody>
			...
			{if ($id_perfil==12) OR ($id_perfil!=12 AND $item->bo_all_domicilio_conocido==1)}
				<tr class=  {if $item->id_alarma_estado == 1 or $item->id_ultimo_evento == 33}
                    ...
                    <td style="{$color}" class="text-center"> {$item->gl_comuna_mordedor} </td>
