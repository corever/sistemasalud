...
<section class="content">
			...
			<form id="form_filtros" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="form-group" style="margin-top: 10px !important; margin-bottom: 10px !important;">
					<div class="col-sm-4">
						...
						<div class="col-sm-8">
							<input type="text" name="folio_expediente" id="folio_expediente" value="" 
					...
					<div class="col-sm-4">
						...
						<div class="col-sm-8">
							<input type="text" name="folio_mordedor" id="folio_mordedor" value="" 
					...
					<div class="col-sm-4">
						...
						<div class="col-sm-8">
							<input type="text" name="microchip_mordedor" id="microchip_mordedor" value=""
    ...
    <div class="box box-primary">
        <div class="box-body" id="contenedor_grilla_registros">
            {if $bandeja == "establecimiento" || $bandeja == "admin" || $bandeja == "nacional" || $bandeja == "editar_direccion"}
                {include file='grilla/grilla_pacientes_editar_direccion.tpl'}
