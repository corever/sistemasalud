        ...
        <div class="col-sm-6">
            ...
            <div class='col-sm-12'>
                ...
                <input type='text' class="form-control"
                       value="{if $arr->arrDirMordedura.gl_direccion}{$arr->arrDirMordedura.gl_direccion}, {/if}{$arr->comuna_mordedura}, {$arr->region_mordedura}" readonly>
            </div>
            </div>
            <div class="row">
            <div class='col-sm-12'>
...
<div class="panel panel-default">
    <div class="panel-heading">
        Detalle de Mordedores
    </div>
    <div class="panel-body">
        <div class="col-sm-12" id="cabecera_grilla_mordedor">
            {include file='bitacora/cabecera_grilla_mordedor.tpl'}
        </div>
	</div>
</div>
